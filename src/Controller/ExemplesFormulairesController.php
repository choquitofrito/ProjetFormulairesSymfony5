...
class ExemplesFormulairesController extends AbstractController
{
    ...
    /**
     * @Route ("/exemples/formulaires/exemple/independant/affichage/form")
     */
    public function exempleIndependantAffichageForm()
    {
        // cette action affiche une vue contenant un formulaire traditionnel
        return $this->render("/exemples_formulaires/exemple_independant_affichage_form.html.twig");
    }

    /**
     * @Route ("/exemples/formulaires/exemple/independant/traitement/post",name ="traitement_form_simple_post")
     */
    public function exempleIndependantTraitementPost(Request $req)
    {
        ...
        return $this->render(
            "/exemples_formulaires/exemple_independant_traitement_post.html.twig",
            [
                'nom' => $nom,
                'age' => $age
            ]
    ...
    /**
     * @Route ("/exemples/formulaires/exemple/independant/traitement/get",name ="traitement_form_simple_get")
     */
    public function exempleIndependantTraitementGet(Request $req)
    {
        ...
        return $this->render(
            "/exemples_formulaires/exemple_independant_traitement_get.html.twig",
            [
                'produit' => $produit,
                'prix' => $prix
            ]
